...
// import getHero from './detailSpider';
const {getHero} = require('./detailSpider')
const dirs = ['data', 'hero', 'hero/img', 'hero/json', 'hero/passive', 'hero/spell', 'hero/skin']
...
function saveNetImg (img) {
  ...
  let name = path.resolve(__dirname, 'hero/img', img)
